...
INSERT INTO flashcards (user_id, term, definition, date_modified, keep_studying) VALUES (10, 'Galactose', 'A sugar found in milk. Galactose is a disaccharide that is made up of two sugars, galactose and glucose, that are bound together.', '9/25/17', false);
INSERT INTO flashcards (user_id, term, definition, date_modified, keep_studying) VALUES (9, 'Gamma ray', 'High-energy electromagnetic radiation emitted by certain radionuclides when their nuclei transition from a higher to a lower energy state. Gamma rays have high energy and a short wave length. All gamma rays emitted from a given isotope have the same energy, a characteristic that enables scientists to identify which gamma emitters are present in a sample. Gamma rays penetrate tissue farther than do beta particles or alpha particles, but leave a lower concentration of ions in their path to potentially cause cell damage. Gamma rays are similar to x-rays.', '9/20/17', true);
...
INSERT INTO flashcards (user_id, term, definition, date_modified, keep_studying) VALUES (9, 'Waardenburg syndrome', ' A genetic disorder that causes deafness, white forelock (a frontal white blaze of hair), a difference of color between the iris of one eye and the other (heterochromia iridis), white eye lashes, and wide-set inner corners of the eyes', '7/10/17', true);
INSERT INTO flashcards (user_id, term, definition, date_modified, keep_studying) VALUES (10, 'Eczema', 'A particular type of inflammatory reaction of the skin in which there is erythema (reddening), edema (swelling), papules (bumps), and crusting of the skin followed, finally, by lichenification (thickening) and scaling of the skin. Eczema characteristically causes itching and burning of the skin.', '8/9/17', true);
...
INSERT INTO subjects (user_id, date_modified,name) VALUES (9,'8/26/17','Antibiotics');
INSERT INTO subjects (user_id, date_modified,name) VALUES (9,'8/17/17','Enzymes');
INSERT INTO subjects (user_id, date_modified,name) VALUES (10,'8/4/17','Atoms');
INSERT INTO subjects (user_id, date_modified,name) VALUES (10,'9/20/17','Chem 101');
INSERT INTO subjects (user_id, date_modified,name) VALUES (10,'9/5/17','Join Pain');
