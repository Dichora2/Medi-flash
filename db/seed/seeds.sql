...
INSERT INTO subjects (user_id, date_modified,name) VALUES 

(1,'8/22/17','Anatomy');
(1,'9/20/17','Medicine');
(1,'7/2/17','Biology');
(2,'8/26/17','Antibiotics');
(2,'8/17/17','Enzymes');
(3,'8/4/17','Atoms');
(3,'9/20/17','Chem 101');
(3,'9/5/17','Join Pain');
...
INSERT INTO users (firstname, lastname, email, username, password_digest) VALUES

('Lenora', 'Rigoni', 'lenorarigoni@gmail.com', 'lenorarigoni', '111');
('Daniel', 'Mercia', 'danielmercia@gmail.com', 'danielmercia', '222');
('Michael', 'Gutleber', 'michaelgutleber@gmail.com', 'michaelgutleber', '333');
...
(2, 'Gamma ray', 'High-energy electromagnetic radiation emitted by certain radionuclides when their nuclei transition from a higher to a lower energy state. Gamma rays have high energy and a short wave length. All gamma rays emitted from a given isotope have the same energy, a characteristic that enables scientists to identify which gamma emitters are present in a sample. Gamma rays penetrate tissue farther than do beta particles or alpha particles, but leave a lower concentration of ions in their path to potentially cause cell damage. Gamma rays are similar to x-rays.', '9/20/17', true);
(1, 'Large-cell lymphoma', 'Cancer of the lymphatic tissue that is characterized by unusually large cells.', '9/18/17', true);
(2, 'Waardenburg syndrome', ' A genetic disorder that causes deafness, white forelock (a frontal white blaze of hair), a difference of color between the iris of one eye and the other (heterochromia iridis), white eye lashes, and wide-set inner corners of the eyes.
', '7/10/17', true);
(3, 'Eczema', 'A particular type of inflammatory reaction of the skin in which there is erythema (reddening), edema (swelling), papules (bumps), and crusting of the skin followed, finally, by lichenification (thickening) and scaling of the skin. Eczema characteristically causes itching and burning of the skin.', '8/9/17', true)
